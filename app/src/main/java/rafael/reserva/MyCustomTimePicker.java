...
public class MyCustomTimePicker extends AlertDialog implements DialogInterface.OnClickListener, TimePicker.OnTimeChangedListener {
    private static final String HOUR = "hour";
    private static final String MINUTE = "minute";
    private static final String IS_24_HOUR = "is24hour";

    private final TimePicker mTimePicker;
    private final MyCustomTimePicker.OnTimeSetListener mTimeSetListener;

    private final int mInitialHourOfDay;
    private final int mInitialMinute;
    private final boolean mIs24HourView;

    View mViewCustomTimePicker;
     ...
     */
    public MyCustomTimePicker(Context context, MyCustomTimePicker.OnTimeSetListener listener, int hourOfDay, int minute, boolean is24HourView) {
...
//            context.getTheme().resolveAttribute(R.attr.timePickerDialogTheme, outValue, true);
     ...
     * @param is24HourView Whether this is a 24 hour view, or AM/PM.
     */
    public MyCustomTimePicker(Context context, int themeResId, MyCustomTimePicker.OnTimeSetListener listener,
        ...
        mViewCustomTimePicker = inflater.inflate(R.layout.my_custom_time_picker, null);
        setView(mViewCustomTimePicker);
        setButton(BUTTON_POSITIVE, "ok", this);
        setButton(BUTTON_NEGATIVE, "cancel", this);
//        setButtonPanelLayoutHint(LAYOUT_HINT_SIDE);

        mTimePicker = (TimePicker) mViewCustomTimePicker.findViewById(R.id.timePicker);
    ...
    public void show() {
        ...
        getButton(BUTTON_POSITIVE).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mViewCustomTimePicker.clearFocus();
                mTimePicker.clearFocus();


                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                    if (mTimePicker.validateInput()) {
                        MyCustomTimePicker.this.onClick(MyCustomTimePicker.this, BUTTON_POSITIVE);
                        dismiss();
                    }
                } else {
                    MyCustomTimePicker.this.onClick(MyCustomTimePicker.this, BUTTON_POSITIVE);
